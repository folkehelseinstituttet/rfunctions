...
org::InitialiseProject(
  HOME="/git/rfunctions/projects/code/project4",
  SHARED="/git/rfunctions/projects/results/project4",
  DATA_RAW="/git/rfunctions/projects/data_raw/project4"
)
